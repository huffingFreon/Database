...
namespace Database
{
    class Database
    {
        public static void Main()
        {
            ...
            GenQuery<Person> ppl;
            Person dan = new Person("Chris", "Farren", "Musician");
            
            using (naw.BuiltConnection)
            {
                naw.BuiltConnection.Open();
                ppl = new GenQuery<Person>(naw.BuiltConnection);
                Console.WriteLine(ppl.AddRow(dan));  
            }
            ...
            //    {
            //        naw.BuiltConnection.Open();
            //        qb = new QueryBuilder(naw.BuiltConnection);
            //        dict = qb.SelectAll();
            //    }
            ...
            //            {
            //                naw.BuiltConnection.Open();
            //                Console.WriteLine(qb.AddRow(strFirstName, strLastName, strJob) + " row(s) added.");
            //            }
